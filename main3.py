...
class MyGame(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        """
        This tracks movement and the location of the character, but also keeps track of whether they have picked up any coins and 
        """
...
if __name__ == "__main__":
    ...
    """
The assets that are used in this program make a game that more resembles something from the Flash game time of the early 2000s - like something that I would play on the lab computer's in elementary school.
It's an interesting way to implement things that we tend to take advantage of in the grand scheme of media and entertainment consumption. The simplest elements tend to be overlooked or looked at as of lesser worry, but they really give life to the crazy ideas that people tend to have in creative avenues. 
    """